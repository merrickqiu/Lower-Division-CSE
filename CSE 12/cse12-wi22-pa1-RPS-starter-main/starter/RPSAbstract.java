...
public abstract class RPSAbstract implements RPSInterface {
    ...
    public boolean isValidMove(String move) {
        ...
        for (String possibleMove : possibleMoves) {
            if (move.equals(possibleMove)) return true; 
        }
    ...
    public void play(String playerMove, String cpuMove) {
       ...
       switch (winner) {
            case INVALID_INPUT_OUTCOME: System.out.println(INVALID_INPUT);
                                        return;
            case TIE_OUTCOME:   System.out.printf(CPU_MOVE, cpuMove);  
                                System.out.println(TIE);
                                numTies++;
                                break;
            case PLAYER_WIN_OUTCOME:    System.out.printf(CPU_MOVE, cpuMove);
                                        System.out.println(PLAYER_WIN);
                                        numPlayerWins++;
                                        break;
            case CPU_WIN_OUTCOME:   System.out.printf(CPU_MOVE, cpuMove);
