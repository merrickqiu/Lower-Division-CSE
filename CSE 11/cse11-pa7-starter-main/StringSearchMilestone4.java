...
class StringSearch {
    ...
    public static void main(String[] args) {
        /*
            MileStone 4 is the same as the final program because I used
            an empty ArrayList of queries and transforms to represent
            no arguments for the query and transform instead of if statements
            to handle different cmd argument counts.
            Turns out writing the program in this way also lets me easily make it
            take in multiple queries and transforms.
        */
